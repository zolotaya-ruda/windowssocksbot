...
ar.uid = 'zxcvbnm1'.encode('utf-16-le')
...
print(b.is_empty, b.task.task_id.decode('utf-16-le'))

task = bot_pb2.BotMsg.TaskCompleted()
task.task_id = '15'.encode('utf-16-le')
task.result = True
task.uid = 'zxcvbnm1'.encode('utf-16-le')
