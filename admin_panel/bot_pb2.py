...
_PANELMSG_TASKGIVEAWAY_TASK = _PANELMSG_TASKGIVEAWAY.nested_types_by_name['Task']
...
PanelMsg = _reflection.GeneratedProtocolMessageType('PanelMsg', (_message.Message,), {
  ...
  'TaskGiveaway' : _reflection.GeneratedProtocolMessageType('TaskGiveaway', (_message.Message,), {
    ...
    'Task' : _reflection.GeneratedProtocolMessageType('Task', (_message.Message,), {
      'DESCRIPTOR' : _PANELMSG_TASKGIVEAWAY_TASK,
      '__module__' : 'test_pb2'
      # @@protoc_insertion_point(class_scope:PanelMsg.TaskGiveaway.Task)
      })
    ,
...
_sym_db.RegisterMessage(PanelMsg.TaskGiveaway.Task)
...
if _descriptor._USE_C_DESCRIPTORS == False:
  ...
  _BOTMSG._serialized_end=349
  _BOTMSG_CONFIG._serialized_start=25
  _BOTMSG_CONFIG._serialized_end=115
  _BOTMSG_CONFIG_HOST._serialized_start=75
  _BOTMSG_CONFIG_HOST._serialized_end=115
  _BOTMSG_REGISTERBOT._serialized_start=118
  _BOTMSG_REGISTERBOT._serialized_end=255
  _BOTMSG_ACTIVITYREPORT._serialized_start=257
  _BOTMSG_ACTIVITYREPORT._serialized_end=286
  _BOTMSG_TASKCOMPLETED._serialized_start=288
  _BOTMSG_TASKCOMPLETED._serialized_end=349
  _PANELMSG._serialized_start=352
  _PANELMSG._serialized_end=562
  _PANELMSG_REGISTRATIONRESULT._serialized_start=364
  _PANELMSG_REGISTRATIONRESULT._serialized_end=415
  _PANELMSG_TASKGIVEAWAY._serialized_start=418
  _PANELMSG_TASKGIVEAWAY._serialized_end=562
  _PANELMSG_TASKGIVEAWAY_TASK._serialized_start=495
  _PANELMSG_TASKGIVEAWAY_TASK._serialized_end=562
  _BACKCONNECTMSG._serialized_start=564
  _BACKCONNECTMSG._serialized_end=685
  _BACKCONNECTMSG_NEWCONNECTION._serialized_start=582
  _BACKCONNECTMSG_NEWCONNECTION._serialized_end=638
  _BACKCONNECTMSG_CONNECTIONCLOSED._serialized_start=640
  _BACKCONNECTMSG_CONNECTIONCLOSED._serialized_end=685
