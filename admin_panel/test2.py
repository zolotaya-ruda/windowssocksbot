...
r = requests.post(url='http://127.0.0.1:8001/gate/', data=struct.pack('=I', 1) + bot.SerializeToString())
...
r1 = requests.post(url='http://127.0.0.1:8001/gate/', data=struct.pack('=I', 2) + ar.SerializeToString())
